...
<section id="checkout-cart">
    ...
    <td style="border: none;">
        <div class="btn-checkout frame-100-1 overflow-hidden border-pri" style="float: right;">
            <button type="submit" style="width: 300px" class="bg-pri border-pri col-fff" name="dathang">Đặt hàng (COD)</button>
        </div>
    </td>
</tr>
<tr>
    ...
    <td style="border: none;">
        <div class="btn-checkout frame-100-1 overflow-hidden border-pri" style="float: right;">
            <button type="submit" style="width: 300px" class="bg-pri border-pri col-fff" name="dathangvnpay">Thanh toán bằng VNPay</button>
        </div>
    </td>
</tr>
